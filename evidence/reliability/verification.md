...
- Current checkout: 87 pytest tests passed; Ruff, strict mypy, and supported-pattern secret scan passed.
- The suite includes Drive text and DOCX note handling plus the live-smoke harness.
...
- Submission PDFs: evaluation 3 pages, case study 4 pages, AI collaboration 5 pages; all final pages inspected. Each file is under 1 MB. They remain drafts for my personal review.
- New Anthropic requests during the first reliability upgrade: zero. The later private live smoke used one Haiku request under a `$0.08` cap.
